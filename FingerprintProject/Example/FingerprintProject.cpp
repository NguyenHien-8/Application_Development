...
const char* supabaseDeleteStatusUrl = "https://sczadjvbayylqoinevmv.supabase.co/rest/v1/rpc/update_delete_status"; 
const char* supabaseAttendanceUrl = "https://sczadjvbayylqoinevmv.supabase.co/rest/v1/rpc/log_attendance_by_fingerprint"; 
...
void setup() {
  ...
  // =======================================================
  // 1. LIÊN KẾT CALLBACKS CHO DETECT (ĐIỂM DANH)
  // =======================================================
