/***************************************************
  ...
  Based on original Adafruit code.
 ****************************************************/
...
uint8_t getFingerprintEnroll() { 
  ...
  // Convert image to characteristics and store in slot 1
  p = finger.image2Tz(1);
  switch (p) {
    case FINGERPRINT_OK:
  ...
  // Convert image to characteristics and store in slot 2
  p = finger.image2Tz(2);
  switch (p) {
    case FINGERPRINT_OK:
      Serial.println("Image converted");
